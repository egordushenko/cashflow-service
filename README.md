...
| Список записей | Форма записи | Справочники |
|----------------|--------------|-------------|
| _добавить скриншот_ | _добавить скриншот_ | _добавить скриншот_ |

---

<div align="center">
Сделано как тестовое задание backend-разработчика · Django + DRF
</div>
